...
def make_pair_debate_many_questions(model_a, model_b, questions, 
                                    debate_history_file,
                                    shuffle_ab = True,
                                    language = 'en'):
    '''
    ...
    for question in questions:
        ...
        if not matched:
            ...
            peer_battle_history = make_pair_debate(model_a, model_b, question, 
                                                   debate_history_file,
                                                   language = language)
...
def peer_evaluate_many_debates(debates, committee, judge_debate_rounds,
                               judge_save_file,
    ...
    for debate in debates:
        ...
        # not debated at all
            ...
            eval = peer_evaluate(committee, debate, 
                                judge_save_file,
        ...
        # evaluated but not enough rounds
            ...
            eval = peer_evaluate(committee, debate, 
                                judge_save_file, all_judge_file,
                                judge_debate_rounds = judge_debate_rounds,
                                evaluate_turn = turn,
